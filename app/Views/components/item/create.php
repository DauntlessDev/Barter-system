    ...
    <div class="main-container">
        ...
        <div class="right-container">
                ...
                <div class="categories">
                    <div class="col">
                        <label for="toys"><input type="checkbox" name="checklist[]" id="toys" value="8"> Toys</label><br>
                        <label for="toys"><input type="checkbox" name="checklist[]" id="sports" value="7"> Sports</label><br>
                        <label for="toys"><input type="checkbox" name="checklist[]" id="school" value="3"> School</label><br>
                        <label for="toys"><input type="checkbox" name="checklist[]" id="others" value="10"> Others</label><br>
                    </div>
                    <div class="col">
                        <label for="toys"><input type="checkbox" name="checklist[]" id="office" value="9"> Office</label><br>
                        <label for="toys"><input type="checkbox" name="checklist[]" id="home" value="5"> Home</label><br>
                        <label for="toys"><input type="checkbox" name="checklist[]" id="hardware" value="4"> Hardware</label><br>
                        <label for="toys"><input type="checkbox" name="checklist[]" id="gadgets" value="3"> Gadgets</label><br>
                    </div>
                    <div class="col">
                        <label for="toys"><input type="checkbox" name="checklist[]" id="entertainment" value="2"> Entertainment</label><br>
                        <label for="toys"><input type="checkbox" name="checklist[]" id="clothing" value="1"> Clothing</label><br>
                    </div>
                </div>
