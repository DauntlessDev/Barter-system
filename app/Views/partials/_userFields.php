<div class="form-group">
    ...
    <input type="text" name="first_name" id="first_name" value="Jane" autocomplete="off" required>
</div>

<div class="form-group">
    <label for="last_name">Last Name:</label>
    <input type="text" name="last_name" id="last_name" value="doe" autocomplete="off" required>
</div>
